...
while True:
        ...
        if face is not None:
            ...
            image_name_path = "./faces/persons/" + person_full_name + "." + person_ID + "." + str(count) + ".jpg"
...
if count == 100:
    ...
    for i, files in enumerate(onlyfiles):
        ...
        labels.append(i)
        full_name, person_id, _, _ = files.split(".")
        labels_to_name[i] = {"full_name": full_name, "person_id": person_id}
